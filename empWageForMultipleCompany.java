...
class empWageForMultipleCompany{
 private static final int IS_PART_TIME=1; 
   ...
   private  static final int NUM_WORKING_DAYS=20;
	public static int EmpWageForCompany(String company,int empRate,int numOfDays,int maxHrs) {
     ...
     while(totalEmpHrs <= maxHrs && totalWorkingDays < numOfDays) {
      ...
      calculateEmpWage("peter england", 20, 8, 28);
      calculateEmpWage("hofman", 30, 8, 28);
      calculateEmpWage("Big bazar", 10, 8, 28);
   }
}
